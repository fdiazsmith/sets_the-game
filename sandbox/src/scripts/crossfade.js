function Transition ( sceneA, sceneB ) {
	...
	this.render = function( delta ) {
		...
		if (transitionParams.animateTransition && false )
		{
			...
			// console.log(transitionParams.transition, transitionParams.transitionSpeed * clock.getElapsedTime());
			// transitionParams.animateTransition = (transitionParams.transition === 0 || transitionParams.transition === 1)? false: true;
		...
		if (transitionParams.transition == 0) {
			...
			// console.log("this scen",this.sceneA);
			...
			// renderer.render( this.sceneA, this.cameraOrtho, fbo, true );
			// renderer.render( this.sceneB, this.cameraOrtho, fbo, true );
